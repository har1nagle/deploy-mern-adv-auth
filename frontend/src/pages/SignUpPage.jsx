...
import PasswordStrenthMeter from "../components/PasswordStrenthMeter"
...
const SignUpPage = () => {
  ...
  return (
    <motion.div
      ...
      className="max-w-md w-full bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-t-2xl shadow-xl overflow-hidden"
    >
      <div className="p-8">
        ...
        <form onSubmit={handleSignUp}>
          ...
          <PasswordStrenthMeter password={password}/>
